...
/** 自定义tabbleView */
@property (nonatomic ,strong)UITableView *photoTabBleView;
...
{
    _photoTabBleView = [[UITableView alloc]initWithFrame:CGRectMake(0,0, kSCREENW, kSCREENH) style:(UITableViewStylePlain)];
    _photoTabBleView.showsVerticalScrollIndicator = NO;
    _photoTabBleView.delegate = self;
    _photoTabBleView.dataSource = self;
    _photoTabBleView.separatorStyle = UITableViewCellSeparatorStyleNone;
    [self.view addSubview:_photoTabBleView];
